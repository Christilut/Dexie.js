...
function getByKeyPath(obj, keyPath, replacementChar) {
...
function setByKeyPath(obj, keyPath, value, replacementChar) {
    if (replacementChar === void 0) { replacementChar = '.'; }
...
function getObjectDiff(a, b, rv, prfx) {
    ...
    keys(a).forEach(function (prop) {
        if (!hasOwn(b, prop)) {
            setByKeyPath(rv, prfx + prop, undefined, REPLACEMENT_CHAR);
        }
        else {
                ...
                if (apTypeName === bpTypeName) {
                    if (intrinsicTypeNameSet[apTypeName] || isArray(ap)) {
                        if (getValueOf(ap, apTypeName) !== getValueOf(bp, bpTypeName)) {
                            setByKeyPath(rv, prfx + prop, b[prop], REPLACEMENT_CHAR);
                        }
                    }
                    else {
...
export { Dexie$1 as Dexie, RangeSet, liveQuery, mergeRanges, rangesOverlap };
